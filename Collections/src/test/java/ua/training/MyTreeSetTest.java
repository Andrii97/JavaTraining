...
public class MyTreeSetTest {
    ...
    // Variables
    private MyTreeSet<Integer> customTreeSet;

    // Tests
    @Before
    public void initTest(){
        customTreeSet = new MyTreeSet<>();
    }
