...
public class View {
    // Text's constants
    public static final String INPUT_MIN_BARRIER = "Please, input INT min barrier of range = ";
    public static final String INPUT_MAX_BARRIER = "Please, input INT max barrier of range = ";
    public static final String INPUT_AGAIN = "Please, input INT value again";
